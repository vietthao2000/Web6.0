class ShipController {
	...
	/*createBullet () {
	  ...
	  //Set firing speed
	  this.bullet.bulletSpeed = this.bulletConfigs.speed[this.i];
	  //Set firing rate, 1 bullet per x milisecs
	  this.bullet.fireRate = this.bulletConfigs.fireRate[this.i];
	  ...
	  this.bullet.trackSprite(this, this.bulletConfigs.x[this.i], this.bulletConfigs.y[this.i]);
	  this.i=(this.i+1)%3;
	}*/
}
